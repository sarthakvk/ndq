...
- What did you decide *not* to support, and does the code actually reject it?
...
When I *do* ask explicitly how to do something ("how do I do X in Zig", "what's the
...
**Production standard** here means *correct and predictable*, not *feature-rich*.
...
- Malformed input produces a clear, actionable error naming *what* and *where*
